...
export const newsFormSchema = z.object({
  ...
  content: z.string().optional().transform(val => val === '' ? undefined : val),
  ...
  image_caption: z.string().optional().transform(val => val === '' ? undefined : val),
  ...
  reading_time: z.number().optional().or(z.string().transform(val => val === '' ? undefined : parseInt(val))),
